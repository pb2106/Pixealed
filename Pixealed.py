...
class PixealedApp:
    ...
    def setup_about_tab(self):
        ...
        about_text = (
            ...
            "To provide irrefutable proof of origin, the Merkle Root, along with critical image metadata, is bound together into a CBOR manifest. This manifest is then cryptographically signed using an Ed25519 elliptic-curve public-key signature scheme. Ed25519 is celebrated for its immunity to side-channel attacks and small, lightning-fast 64-byte signatures. Upon running Pixealed for the first time, a local Ed25519 keypair is automatically generated and securely stored in your './keys' directory as a `.bin` file. When you encrypt an image, the software binds the public key seamlessly into the proprietary `.pxl` binary structure. \n\n"
